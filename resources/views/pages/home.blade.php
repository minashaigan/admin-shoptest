                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Click on 'View All Users' to view all your current users</p>
                                <a href="{{URL::route('home')}}" class="btn btn-light">View All Users</a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="service-item">
                                ...
                                <a href="#" class="btn btn-light">View All Posts</a>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="service-item">
                                ...
                                <a href="#" class="btn btn-light">View All Images</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.row (nested) -->
